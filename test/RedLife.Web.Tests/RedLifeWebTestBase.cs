...
using RedLife.Models.TokenAuth;
...
{
    public abstract class RedLifeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RedLifeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RedLifeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RedLifeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RedLifeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RedLifeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RedLifeDbContext, Task<T>> func)
        {
            T result;
